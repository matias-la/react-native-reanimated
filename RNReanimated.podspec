...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                  RNReanimated
                   DESC
  s.homepage     = "https://github.com/ExodusMovement/react-native-reanimated"
  s.license      = "MIT"
  # s.license    = { :type => "MIT", :file => "FILE_LICENSE" }
  s.author       = { "author" => "author@domain.cn" }
  s.platforms    = { :ios => "9.0", :tvos => "9.0" }
  s.source       = { :git => "https://github.com/ExodusMovement/react-native-reanimated.git", :tag => "#{s.version}" }
